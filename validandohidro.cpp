...
public:
	...
	bool validarFormaHidro(int colunaNumero1, int colunaNumero2, int letra2, char m[15][15])
	{
		//TODO validando segunda entrada 
		if ( ( colunaNumero2 == colunaNumero1 + 1 ) || ( colunaNumero2 == colunaNumero1 - 1 ) && ( m [letra2] [colunaNumero2] == AGUA ) )
		{
			return true;
		}
		else
		...
		for (int i = 1; i <= 3; i++)
		{
			...
			do
			{
				...
				else
				{
					...
					do
					{ // verifica se a segunda letra é valida
						hidrohaviao1.posicao2 = hidrohaviao1.LerIndiceNumero(entradaValida, i, H);
						coluna2 = hidrohaviao1.LerIndiceLetra(i, H);
					
						cout << endl
							 << " validar Segunda posicao " << hidrohaviao1.posicao2;
							 
						if (hidrohaviao1.validarFormaHidro(hidrohaviao1.posicao1, hidrohaviao1.posicao2, tabuleiro))
						{
							entradaValida = true;
					...
					} while (! ( hidrohaviao1.validarFormaHidro(hidrohaviao1.posicao1, hidrohaviao1.posicao2, coluna2, tabuleiro ) ) );
