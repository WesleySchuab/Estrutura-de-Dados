  ...
  void BatalhaPvp(){
    ...
    */
      ...
      for( int j = 1; j < 2; j++ ){
          ...
          do {
              cout<< endl<<"Estou no lugar certo";              
                cout << endl <<" Digite o [ Numero ] da " <<i << " posicoes para HidroAviao "<< endl;
                cin >> hidrohaviao1.posicao1;
                cout << endl;
                cout << AMARELO << nomeJogador;
                
              cout <<" Sua resposta está: " << hidrohaviao1.limiteLetra(hidrohaviao1.posicao1) <<endl;
              
              if(!(hidrohaviao1.limiteNumero(hidrohaviao1.posicao1)))
                     {
                         cout << "Posicao Invalida" << endl;
                     }
            } while  (!(hidrohaviao1.limiteNumero(hidrohaviao1.posicao1)));

             cout << endl <<" Digite o [ letra ] da" <<i << "  posicoes para HidroAviao ";
             cout << endl;
             cin >> letra;
             // Deixa a letra maiuscula 
            letra = toupper(letra);
      ...
      for(int i= 0; i <= 5){
       ...
       for( int i = 1; i < 3; i++ ){
           ...
           do {
                cout << endl <<" Digite o [ Numero ] da " <<i << " posicoes para SUBMARINO "<< endl;
                cin >> hidrohaviao1.posicao1;
                cout << endl;
                cout << AMARELO << nomeJogador;
               if(hidrohaviao1.limiteNumero(hidrohaviao1.posicao1))
             ...
             cout << endl <<" Digite o [ letra ] da" <<i << "  posicoes para SUBMARINO ";
             cout << endl;
             cin >> letra;
             // Deixa a letra maiuscula 
            letra = toupper(letra);
