...
public:
	...
	int LerIndiceLetra(int ordinal,string embarcacao ) {
		...
		do {
			...
			{
				entrada = true;
				cout<< AMARELO << endl <<" Entrada valida NO  limite do tabuleiro";
				cout << BRANCO;
			} else {
				entrada =false;
	...
	int LerIndiceNumero(bool &entrada, int ordinal, string embarcacao ) {
		...
		do
		{
			...
			{
				entrada = true;
				cout << endl << AMARELO << endl <<" Entrada valida NO  limite do tabuleiro" << endl;
				cout << BRANCO;
			} else {
				entrada =false;
				cout << VERMELHO <<endl << " Entrada Invalida fora do limite do tabuleiro ";
...
//TODO Implentar outras embarcaC'C5es
	...
	for(int i = 1; i <=2; i++) {
		...
		letra1 = encoracado.LerIndiceLetra(1,E);
